                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                          ...
                                          <li class="list-inline-item">Add Vendor</li>
                                        </ul>
                                    </div>
                                 </div>
                            </div>
                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                            <label for="businessEntityName">Business Entity Name *</label>
                            <input type="text" class="form-control" id="businessEntityName">
                            </div>
                            <div class="form-group col-md-4">
                            <label for="typeOfEntity">Type of Entity</label>
                            <select name="countryCode" id="" class="form-control">
                                <option  value="" Selected>Entiry 1</option>
                                <option  value="">Entiry 2</option>
                            </select>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <select name="countryCode" id="" class="form-control">
                                ...
                                <optgroup label="Other countries">
                                    <option data-countryCode="DZ"<i> value="213">Algeria (+213)</option>
